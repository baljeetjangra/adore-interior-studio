...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-addore-primary relative overflow-hidden">
      {/* Three.js Elements */}
      <AboutThreeElements />
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-addore-warm-gray leading-relaxed mb-6">
                At Addore Interior Studio, we believe your home should reflect your personality and lifestyle. 
                With years of expertise in interior design, architecture, and remodeling, we craft spaces that 
                blend elegance and functionality.
              </p>
              <p className="text-lg text-addore-warm-gray leading-relaxed mb-8">
                Led by Rohit Jangra, our team is dedicated to transforming your vision into reality through 
