...
const Services = () => {
  const services = [
    {
      ...
      description:
        "Custom designed kitchens that blend functionality with style. From modern layouts to traditional designs.",
      features: [
        "Custom Cabinets",
        "Premium Appliances",
    ...
    },
    {
      ...
      description:
        "Create stunning living spaces that reflect your personality and accommodate your lifestyle needs.",
      features: [
        "Furniture Selection",
        "Lighting Design",
        "Color Coordination",
    ...
    },
    {
      ...
      description:
        "Peaceful and comfortable bedroom designs that promote rest and relaxation while maximizing space.",
    ...
    },
    {
      ...
      description:
        "Professional workspace designs that boost productivity and create a positive work environment.",
    ...
    },
    {
      ...
      description:
        "Custom wardrobe solutions that maximize storage while complementing your room's aesthetic.",
    ...
    },
    {
      ...
      description:
        "Complete home makeovers and renovations that transform your existing space into your dream home.",
  ...
  return (
    <section
      id="services"
      className="py-20 bg-addore-light-gray relative overflow-hidden"
    >
      {/* Three.js Elements */}
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="flex items-center justify-center w-16 h-16 bg-addore-primary rounded-full mb-6 mx-auto">
                <div className="text-addore-accent">{service.icon}</div>
              </div>
